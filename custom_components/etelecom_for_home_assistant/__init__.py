"""Version: 1.0.0. The Etelecom integration."""
...
from .const import CONF_ACCOUNT_ID, CONF_LOGIN, CONF_PASSWORD, CONF_TOKEN, CONF_USER_ID, DOMAIN
from .coordinator import EtelecomDataUpdateCoordinator
from .formatting import format_account_title, format_device_name
...
async def async_setup_entry(hass: HomeAssistant, entry: EtelecomConfigEntry) -> bool:
    ...
    latest_title = format_account_title(data_coordinator.data, fallback=entry.title or 'Etelecom')
